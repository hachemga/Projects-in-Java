...
public class MatrixImage implements Image {
    ...
    */
    ...
    public double contrast(Coordinate p0, Coordinate p1) throws InputMismatchException {
        // TODO
        if ((p1.x < 0)  || (p0.x < 0) || (p0.x >= sizeX() ) || (p1.x >= sizeX()) ||
                (p0.y < 0) || (p0.y >= sizeY()) || (p1.y < 0) || (p1.y >= sizeY())){
            throw new InputMismatchException("Coordinates are wrong.");
        }
